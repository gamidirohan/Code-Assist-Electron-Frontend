          ...
          >
            {items.map((item, idx) => (
              ...
              >                <button
                  ...
                  key={item.title}
                  className="flex h-10 w-10 items-center justify-center rounded-full bg-white/10 hover:bg-white/20 border border-white/20 hover:border-white/30 backdrop-blur-sm transition-all duration-200"
                >
                  <div className="h-4 w-4 text-white/80 hover:text-white transition-colors">{item.icon}</div>
                </button>
              </motion.div>
            ))}
          </motion.div>
